          ...
          <div className="space-y-8 opacity-0 animate-[fade-in_0.8s_ease-out_0.2s_forwards]">
            ...
            <div className="space-y-6">
              <div className="flex items-start space-x-4 group hover:translate-x-2 transition-transform duration-300">
                ...
                <div>
                  <h3 className="font-semibold text-black mb-2 group-hover:text-gray-800 transition-colors duration-300">Consultation</h3>
              ...
              <div className="flex items-start space-x-4 group hover:translate-x-2 transition-transform duration-300">
                <div className="w-2 h-2 bg-black rounded-full mt-3 group-hover:scale-150 transition-transform duration-300"></div>
                <div>
                  <h3 className="font-semibold text-black mb-2 group-hover:text-gray-800 transition-colors duration-300">Custom Solutions</h3>
                  <p className="text-gray-600">
              ...
              <div className="flex items-start space-x-4 group hover:translate-x-2 transition-transform duration-300">
                <div className="w-2 h-2 bg-black rounded-full mt-3 group-hover:scale-150 transition-transform duration-300"></div>
                <div>
                  <h3 className="font-semibold text-black mb-2 group-hover:text-gray-800 transition-colors duration-300">Ongoing Support</h3>
                  <p className="text-gray-600">
          ...
          <div className="bg-gray-50 rounded-lg p-8 hover:shadow-xl transition-all duration-500 opacity-0 animate-[fade-in_0.8s_ease-out_0.4s_forwards]">
            <form className="space-y-6">
              <div className="grid grid-cols-2 gap-4">
                <div className="group">
                  <label className="block text-sm font-medium text-gray-700 mb-2 group-hover:text-black transition-colors duration-300">
                    First Name
                  </label>
                  <Input placeholder="John" className="w-full transition-all duration-300 focus:scale-105" />
                </div>
                <div className="group">
                  <label className="block text-sm font-medium text-gray-700 mb-2 group-hover:text-black transition-colors duration-300">
                    Last Name
                  </label>
                  <Input placeholder="Doe" className="w-full transition-all duration-300 focus:scale-105" />
                </div>
              </div>
              ...
              <div className="group">
                ...
                <Input type="email" placeholder="john@example.com" className="w-full transition-all duration-300 focus:scale-105" />
              </div>
              ...
              <div className="group">
                ...
                <Input placeholder="$100,000" className="w-full transition-all duration-300 focus:scale-105" />
              </div>
              ...
              <Button className="w-full bg-black text-white hover:bg-gray-800 py-3 transition-all duration-300 hover:scale-105 hover:shadow-lg">
                Submit Inquiry
              </Button>
            </form>
          </div>
